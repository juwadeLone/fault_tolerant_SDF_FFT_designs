`timescale 1ns/1ps
// ROM-fed FI shell for S2: on-chip stimulus ROM -> DUT; UART only for FI commands.
// External ports kept small for synth/impl. Not a paper fair-kernel top.
module top_fi_rom_s2 (
    input  wire clk,
    input  wire rst,
    input  wire uart_rx,
    ...
    localparam INIT_FILE = "S2_input.mem";
