# Configuration guide — S3 SubFFT per-stage ECC (thresholded)

SubFFT per-stage online ECC recovery design, with residual compensation removed and syndrome thresholding (τ=4).
...
4. Set top module to `top_s3_subfft_ecc`.
...
**Threshold:** arithmetic acceptance uses τ=4 (TOL=2τ).
