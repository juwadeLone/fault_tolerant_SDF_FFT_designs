# Configuration guide — P2 PFFT TMR

PFFT TMR masking design without the large frame buffer (paper resource / timing top).

## Top module

`top_p2_pfft_tmr_no_framebuf_v1`
...
4. Set top module to `top_p2_pfft_tmr_no_framebuf_v1`.
...
Use `top_p2_pfft_tmr_no_framebuf_v1`.
