...
// Fair-kernel P2: complete-stage TMR on canonical no-exchange PFFT.
// No AXI/debug wrap; no terminal frame-pair buffer (same compare口径 as P0/P1).
...
(* keep_hierarchy = "yes" *) module p2_pfft_tmr_no_framebuf_core_v1(
 input wire clk,input wire rst,input wire in_valid,input wire in_last,
 input wire signed[34:0]in0_re,in0_im,in1_re,in1_im,in2_re,in2_im,in3_re,in3_im,
 output wire out_valid,output wire out_last,
 output wire signed[34:0]out0_re,out0_im,out1_re,out1_im,out2_re,out2_im,out3_re,out3_im
...
wire[10:0]v,l;
wire signed[34:0]r0[0:10],i0[0:10],r1[0:10],i1[0:10];
wire signed[34:0]r2[0:10],i2[0:10],r3[0:10],i3[0:10];
...
module top_p2_pfft_tmr_no_framebuf_v1(
 input wire clk,input wire rst,input wire in_valid,input wire in_last,
 input wire signed[34:0]in0_re,in0_im,in1_re,in1_im,in2_re,in2_im,in3_re,in3_im,
 output wire out_valid,output wire out_last,
 output wire signed[34:0]out0_re,out0_im,out1_re,out1_im,out2_re,out2_im,out3_re,out3_im
);
p2_pfft_tmr_no_framebuf_core_v1 u(
